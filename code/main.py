...
from .models import Cifar10Model, Places365Model, VideoDAVISModel
from .dataset import CIFAR10_DATASET, PLACES365_DATASET, DAVIS
...
def main(options):
    ...
    with tf.Session() as sess:
        ...
        ### VIDEO COLORIZATION
        elif options.dataset == DAVIS:
            model = VideoDAVISModel(sess, options)
