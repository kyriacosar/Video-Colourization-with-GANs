...
class ModelOptions:
    def __init__(self):
        ...
        parser.add_argument('--dataset', type=str, default='davis', help='the name of dataset [places365, cifar10, davis] (default: places365)')
        ...
        parser.add_argument('--log-interval', type=int, default=1, help='how many iterations to wait before logging training status (default: 10)')
